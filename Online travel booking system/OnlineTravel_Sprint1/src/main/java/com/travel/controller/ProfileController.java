...
public class ProfileController {
	...
	@GetMapping("/fullName/{searchFullName}")
	public ResponseEntity<ProfileDTO> getProfileByFullName(@PathVariable String searchFullName)throws Exception
	{
		Profile profile=profileService.getProfileByFullName(searchFullName);
		ProfileDefaultResponseDTO dto=ProfileDTOConvertor.getProfileDefaultDTO(profile);
